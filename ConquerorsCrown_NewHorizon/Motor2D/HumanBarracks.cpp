			...
			if (App->input->GetKey(SDL_SCANCODE_1) == KEY_DOWN || create_swordman == true)
			{
				if (Troop.size() < 6)
				{
					...
					case 0:
						...
						item->bar = App->gui->CreateGuiElement(Types::bar, pos0.x, pos0.y + 20, { 436, 107, 46, 9 }, App->scene->ingameUI, nullptr, NULL);
						break;
					case 1:
						item->image = App->gui->CreateGuiElement(Types::image, pos1.x, pos1.y, { 1186, 49, 46, 38 }, App->scene->ingameUI, nullptr, NULL);
						item->bar = App->gui->CreateGuiElement(Types::bar, pos1.x, pos1.y + 20, { 436, 107, 46, 9 }, App->scene->ingameUI, nullptr, NULL);
						break;
					case 2:
						item->image = App->gui->CreateGuiElement(Types::image, pos2.x, pos2.y, { 1186, 49, 46, 38 }, App->scene->ingameUI, nullptr, NULL);
						item->bar = App->gui->CreateGuiElement(Types::bar, pos2.x, pos2.y + 20, { 436, 107, 46, 9 }, App->scene->ingameUI, nullptr, NULL);
						break;
					case 3:
						item->image = App->gui->CreateGuiElement(Types::image, pos3.x, pos3.y, { 1186, 49, 46, 38 }, App->scene->ingameUI, nullptr, NULL);
						item->bar = App->gui->CreateGuiElement(Types::bar, pos3.x, pos3.y + 20, { 436, 107, 46, 9 }, App->scene->ingameUI, nullptr, NULL);
						break;
					case 4:
						item->image = App->gui->CreateGuiElement(Types::image, pos4.x, pos4.y, { 1186, 49, 46, 38 }, App->scene->ingameUI, nullptr, NULL);
						item->bar = App->gui->CreateGuiElement(Types::bar, pos4.x, pos4.y + 20, { 436, 107, 46, 9 }, App->scene->ingameUI, nullptr, NULL);
						break;
					case 5:
						item->image = App->gui->CreateGuiElement(Types::image, pos5.x, pos5.y, { 1186, 49, 46, 38 }, App->scene->ingameUI, nullptr, NULL);
						item->bar = App->gui->CreateGuiElement(Types::bar, pos5.x, pos5.y + 20, { 436, 107, 46, 9 }, App->scene->ingameUI, nullptr, NULL);
						break;
					}
...
void HumanBarracks::ImageSelected()
{
	if (Troop.size() == 6)
	{
		...
		Troop[5]->bar = App->gui->CreateGuiElement(Types::bar, pos5.x, pos5.y + 20, { 436, 107, 46, 9 }, App->scene->ingameUI, nullptr, NULL);
	}
	if (Troop.size() >= 5)
	{
		if (Troop[4]->type == 1)
		...
		Troop[4]->bar = App->gui->CreateGuiElement(Types::bar, pos4.x, pos4.y + 20, { 436, 107, 46, 9 }, App->scene->ingameUI, nullptr, NULL);
	}
	if (Troop.size() >= 4)
	{
		if (Troop[3]->type == 1)
		...
		Troop[3]->bar = App->gui->CreateGuiElement(Types::bar, pos3.x, pos3.y + 20, { 436, 107, 46, 9 }, App->scene->ingameUI, nullptr, NULL);
	}
	if (Troop.size() >= 3)
	{
		if (Troop[2]->type == 1)
		...
		Troop[2]->bar = App->gui->CreateGuiElement(Types::bar, pos2.x, pos2.y + 20, { 436, 107, 46, 9 }, App->scene->ingameUI, nullptr, NULL);
	}
	if (Troop.size() >= 2)
	{
		if (Troop[1]->type == 1)
		...
		Troop[1]->bar = App->gui->CreateGuiElement(Types::bar, pos1.x, pos1.y + 20, { 436, 107, 46, 9 }, App->scene->ingameUI, nullptr, NULL);
	}
	if (Troop.size() >= 1)
	{
		if (Troop[0]->type == 1)
		...
		Troop[0]->bar = App->gui->CreateGuiElement(Types::bar, pos0.x, pos0.y + 20, { 436, 107, 46, 9 }, App->scene->ingameUI, nullptr, NULL);
	}
}
